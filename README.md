...
### Detailed examples
Head on over to `./example` to get familiar with **callbacks**, **timeouts**, **testing**, **connectors** and
...
Head on over to [./examples](./examples) to get familiar with the syntax 😊
